...
json_file = open('C:/Users/AC/PycharmProjects/FaceEmotionRecognition/model.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
classifier = model_from_json(loaded_model_json)

# load weights into new model
classifier.load_weights("C:/Users/AC/PycharmProjects/FaceEmotionRecognition/FER_model.h5")
