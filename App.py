...
# load model
emotion_dict = {0:'angry', 3 :'happy', 6: 'neutral', 4:'sad', 5: 'surprise',1:'Disgust',2 :'fear'}
# load json and create model
json_file = open("C:/Users/AC/Downloads/Project/model.json", 'r')
loaded_model_json = json_file.read()
json_file.close()
classifier = model_from_json(loaded_model_json)

# load weights into new model
classifier.load_weights("C:/Users/AC/Downloads/Project/FER_model.h5")

#load face
try:
    face_cascade = cv2.CascadeClassifier("C:/Users/AC/Downloads/Project/haarcascade_frontalface_default.xml")
except Exception:
